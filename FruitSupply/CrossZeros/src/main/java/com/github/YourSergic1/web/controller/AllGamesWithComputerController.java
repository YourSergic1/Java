...
public class AllGamesWithComputerController {
    ...
    @Autowired
    public AllGamesWithComputerController(RepositoryServiceImpl repositoryServiceImpl, GameServiceImplementation gameServiceImplementation) {
    ...
    public String allGamesWithComputer(Principal principal, Model model) {
        List<GameEntity> allGames = repositoryServiceImpl.getAllGamesWithComputer(principal);
